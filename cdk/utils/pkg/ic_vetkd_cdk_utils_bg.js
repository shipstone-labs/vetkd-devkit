...
const IBECiphertextFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_ibeciphertext_free(ptr >>> 0, 1),
      );
/**
...
export class IBECiphertext {
  ...
  static encrypt(derived_public_key_bytes, derivation_id, msg, seed) {
    ...
    const ret = wasm.ibeciphertext_encrypt(
      ptr0,
      len0,
      ptr1,
      len1,
...
const TransportSecretKeyFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_transportsecretkey_free(ptr >>> 0, 1),
      );
/**
...
export class TransportSecretKey {
  ...
  decrypt(encrypted_key_bytes, derived_public_key_bytes, derivation_id) {
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.transportsecretkey_decrypt(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
  ...
  decrypt_and_hash(
    ...
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.transportsecretkey_decrypt_and_hash(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
