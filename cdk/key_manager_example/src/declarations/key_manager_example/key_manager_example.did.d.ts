...
export type Result_1 =
  ...
  | { Err: string };
export type Result_2 = { Ok: [] | [AccessRights] } | { Err: string };
export interface _SERVICE {
  get_accessible_shared_key_ids: ActorMethod<[], Array<[Principal, ByteBuf]>>;
  get_encrypted_vetkey: ActorMethod<[Principal, ByteBuf, ByteBuf], Result>;
  get_shared_user_access_for_key: ActorMethod<[Principal, ByteBuf], Result_1>;
