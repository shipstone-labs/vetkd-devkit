...
export function vaultFromContent(owner: Principal, name: string, passwords: Array<[string, PasswordModel]>, users: Array<[Principal, AccessRights]>): VaultModel {
...
export function summarize(vault: VaultModel, maxLength = 1500) {
    ...
    div.innerHTML += "Owner: " + vault.owner.toString() + ", " + vault.users.length + " users";
