...
export type Result = { Ok: [] | [ByteBuf] } | { Err: string };
export type Result_1 = { Ok: Array<[ByteBuf, ByteBuf]> } | { Err: string };
export type Result_2 = { Ok: ByteBuf } | { Err: string };
export type Result_3 =
  | { Ok: Array<[Principal, AccessRights]> }
  | { Err: string };
export type Result_4 = { Ok: [] | [AccessRights] } | { Err: string };
export type Result_5 = { Ok: Array<ByteBuf> } | { Err: string };
export interface _SERVICE {
  get_accessible_shared_map_names: ActorMethod<[], Array<[Principal, ByteBuf]>>;
  get_all_accessible_encrypted_maps: ActorMethod<[], Array<EncryptedMapData>>;
  ...
  get_shared_user_access_for_map: ActorMethod<[Principal, ByteBuf], Result_3>;
