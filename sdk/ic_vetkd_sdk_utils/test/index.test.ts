import { DerivedPublicKey, EncryptedKey, IdentityBasedEncryptionCiphertext, TransportSecretKey, augmentedHashToG1, hashToScalar, deriveSymmetricKey } from "../src/index";
...
test('protocol flow with precomputed data', () => {
    ...
    assertEqual(bytesToHex(symKey), "4e91306f72d20c58379ddf86e40869706c8c533d40c277cd808abaf6ac623fc1");
...
test('xmd test vectors', () => {
    ...
    for(const tv of testVectors) {
        ...
        assertEqual(bytesToHex(xmd), expected);
    }
});
